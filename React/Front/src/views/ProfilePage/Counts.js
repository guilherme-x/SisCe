            ...
            <Card style={{ width: "40%", marginRight: "2.2em", boxShadow: "0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)" }} className={classes.root} variant="outlined">
                <CardContent>
                    ...
                    <Typography style={{ color: "#0b102d" }} variant="h2" component="h2">
                        {saida.length}
                        <LaptopIcon fontSize="large" style={{ color: "#0b102d", marginLeft: "0.5em" }} />

                    </Typography>
                </CardContent>
                <CardActions>
                    <Button color="default" style={{ "&:hover": { color: "red" } }} href="#tabelaAparelhos" size="small">VER TODOS</Button>
                </CardActions>
            </Card>
            <Card style={{ width: "40%", marginRight: "2.2em", boxShadow: "0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)" }} className={classes.root} variant="outlined">
                <CardContent>
                    ...
                    <Typography style={{ color: "#0b102d" }} variant="h2" component="h2">
                        ...
                        <GroupIcon fontSize="large" style={{ color: "#0b102d", marginLeft: "0.5em" }} />
            ...
            <Card style={{ width: "40%", marginRight: "0", boxShadow: "0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)" }} className={classes.root} variant="outlined">
                <CardContent>
                    ...
                    <Typography style={{ color: "#0b102d" }} variant="h2" component="h2">
                        ...
                        <AssignmentIcon fontSize="large" style={{ color: "#0b102d", marginLeft: "0.5em" }} />
                    </Typography>
                </CardContent>
                <CardActions>
                    <Button href="#tabelaAquisicoes" size="small">VER TODAS</Button>
                </CardActions>
            </Card>
        </div>
